...
public class GuardUI : NetworkBehaviour
{
    ...
    public IEnumerator Caught()
    {
        ...
        if (remaining == 1)
        {
            objText.text = "Only 1 Thief Remains! Find Them Before They Escape!";
        }
        else
        {
    ...
    public IEnumerator SingleEscape()
    {
        ...
        if (remaining == 1)
        {
            objText.text = "A Thief Has Escaped! Find The Last Thief Before They Escape!";
        }
        else
        {
            objText.text = "A Thief Has Escaped! Find The Remaining " + remaining + "Thieves Before It's Too Late";
        }
